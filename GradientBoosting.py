...
grid_search = GridSearchCV(xgb.XGBRegressor(random_state=42), param_grid, cv=5, scoring='neg_mean_squared_error', n_jobs=-1, verbose=3)
...
joblib.dump(best_model, 'xgboost_wind_power_model.pkl')
